    ...
    protected function regFiles() {
        ...
        $this->cs->registerScript('jplayer_'.$this->wpId, "
            ...
            $('#jp_container_".$this->wpId."').hover(function () {
               ...
               $('.jp-controls li a').fadeTo('fast',0.8);
               $('.jp-volume-bar').fadeTo('fast',0.8);
               $('.jp-toggles').fadeTo('fast',0.8);

            }, function () {
                $(this).find('div.jp-interface').fadeTo('fast', 0);
                $('.jp-controls li a').fadeTo('fast',0);
                $('.jp-volume-bar').fadeTo('fast',0);
                $('.jp-toggles').fadeTo('fast',0);
            });
        ");
    }
}