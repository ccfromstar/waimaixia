...
uploadifyLang['existsMsg1']     = '选择上传的文件';
uploadifyLang['existsMsg2']     = '之前已经上传过到服务器上';
uploadifyLang['existsMsg3']     = '确认继续上传并覆盖原来的文件吗?';
uploadifyLang['errorMsg1']      = '文件不能加入上传队列:';
uploadifyLang['errorMsg2']      = 'The number of files selected exceeds the remaining upload limit';
uploadifyLang['errorMsg3']      = '一次只能上传';
uploadifyLang['errorMsg3_1']      = '张图片';

uploadifyLang['errorMsg4']      = '文件 ';
uploadifyLang['errorMsg5']      = '超出大小限制';
