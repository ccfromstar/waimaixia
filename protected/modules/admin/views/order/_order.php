<tbody id="order<?php echo $data->order_sn ?>" class="order closed-order">
	...
	<tr id="item<?php echo $data->order_sn; ?>" class="order-item">
		...
		<?php echo CHtml::link(CHtml::image(Yii::app()->baseUrl."/images/admin_img/view.png","查看"),array("order/view","id"=>$data->id))?>
		
		<?php echo CHtml::Link(CHtml::image(Yii::app()->baseUrl."/images/admin_img/delete.png",'删除'),array("order/delete","id"=>$data->id),array('class'=>'Order_delete'))?>
		</td>
		<?php endif;?>
	</tr>
<?php endforeach;?>
