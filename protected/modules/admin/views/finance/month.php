...
<div class="search-form" id="filterForm">
    <div class="condition">
		...
		<?php echo CHtml::button('导出月报表', array('id' => 'btnExport', 'class' => 'btn btn-primary')); ?>
...
$this->widget('zii.widgets.grid.CGridView', array(
    'dataProvider'=>$model->monthStatic(),
    'ajaxUpdate' => false,
...
$(function(){
	$("#btnExport").click(function(){
		location.href = "/admin/finance/export.html?type=month&nowtime="+$("#nowtime").val();
	});
});
</script>