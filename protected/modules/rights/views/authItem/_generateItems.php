...
<?php else: ?>
	...
	<tr><th  class="no-items-row" style="height:30px" colspan="3"><?php echo Rights::t('core', 'No actions found.'); ?></th></tr>
...
<?php if( $items['modules']!==array() ): ?>
	...
	<?php if( $displayModuleHeadingRow===true ): ?>
		...
		<tr><th class="module-heading-row" style="height:30px;background:#F8F9FE;border-bottom:1px solid #E3EBF8;" colspan="3"><?php echo Rights::t('core', 'Modules'); ?></th></tr>

	<?php endif; ?>

	<?php foreach( $items['modules'] as $moduleName=>$moduleItems ): ?>

		<tr><th class="module-row" style="height:30px" colspan="3"><?php echo ucfirst($moduleName).'Module'; ?></th></tr>
